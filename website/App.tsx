  ...
  return (
    <div className="warpper">
      <GithubCorner
        fixed
        target="__blank"
        href="https://github.com/uiwjs/react-md-editor"
      />
      ...
      <div className="badges">
        ...
        <Github user="uiwjs" repo="react-md-editor">
          ...
          <Github.Social
            type="stars"
            href="https://github.com/uiwjs/react-md-editor/stargazers"
          />
          <Github.Social
            type="watchers"
            href="https://github.com/uiwjs/react-md-editor/watchers"
          />
        </Github>
      </div>
      <div>First</div>
      ...
      <MarkdownPreview
        style={{ paddingTop: 30 }}
        source={ReadmeStr.replace(/([\s\S]*)<!--dividing-->/, "")}
      />
    </div>
  );
}
